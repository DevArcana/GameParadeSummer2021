...
namespace Ability.Abilities
{
    public class DiagonalDashAbility : BaseAbility
    {
        ...
        public override string Tooltip => $"Dash up to {Distance} (2 + {AgilityPercentage.ToPercentage()} Agility) units in any ordinal direction, ignoring any enemies on the way.";
